    ...
    def test_spec(self):
        for version in [1, 3, 4]:
            ...
            for v in vectors['vectors']:
                ...
                # Self-consistency
                self.assertEqual(pt, triplesec.decrypt(triplesec.encrypt(pt, key, keccak_compatibility=keccak_compatibility), key, keccak_compatibility=keccak_compatibility))
