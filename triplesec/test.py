...
class TripleSec_tests(unittest.TestCase):
    ...
    def test_ciphers(self):
        ...
        self.assertEqual(b'Hello world!', triplesec.XSalsa20.decrypt(ciphertext,
        ...
        self.assertEqual('\x00' * 64, triplesec.XSalsa20.decrypt(ciphertext,
            b'this is 32-byte key for xsalsa20'))

        self.assertEqual(b'=)', triplesec.XSalsa20.decrypt(
            unhex('fe989ef7d53f8a9a9feb6d399aba66350544f6d83413b60fc99a'),
            unhex('b867636bd9a368efff7bf349b37758d986348b98a5e54a12db86fc72cc47ecc9')))

        self.assertEqual(unhex('1e012f9511a3d980109670bff033d3388fb157ff15e753378d3a'),
            triplesec.Twofish.decrypt(
            unhex('f451b4b1563350cbd9281548c38d7b0f688bcc8c8969210804ac4ed328bb8d9a26428e42269784237eb6'),
            unhex('1b7fc636bfe805a01f4f6b145f979093ca7399b3abe91c8a308f86c5830f893c')))

        self.assertEqual(unhex('f451b4b1563350cbd9281548c38d7b0f688bcc8c8969210804ac4ed328bb8d9a26428e42269784237eb6'),
            triplesec.AES.decrypt(
            unhex('d99c7d52fa4f348f750f1baac984db5470627f91c6bfc24bdd7c00a2f4f756d3cbc12fff7b9103647783cae2180f502c1979f68b15d2c48b73d1'),
            unhex('58b375e564318bae043791897f76c56b572ee60f87dffa8eac8055f3f71ececc')))
